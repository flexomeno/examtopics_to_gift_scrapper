...
class Card:
    """ 
        Represents a structure which holds a question with answers and a correct answer
...
class CardList:
    ...
    def __get_question_number(self, card_body) -> str:
        """ 
            Get the question nubmer for easier debugging purposes.
    ...
    def extract_questions_and_answers(self):
        """
            Function to extract questions and answers from the card list
        """
        qa_list = []
